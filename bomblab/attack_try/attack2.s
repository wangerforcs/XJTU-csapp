...
00000000000010d0 <gets@plt>:
    ...
    10d4:	f2 ff 25 f5 2e 00 00 	bnd jmpq *0x2ef5(%rip)        # 3fd0 <gets@GLIBC_2.2.5>
...
00000000000010e0 <_start>:
    ...
    10ff:	ff 15 d3 2e 00 00    	callq  *0x2ed3(%rip)        # 3fd8 <__libc_start_main@GLIBC_2.34>
    1105:	f4                   	hlt    
...
0000000000001110 <deregister_tm_clones>:
    ...
    1123:	48 8b 05 b6 2e 00 00 	mov    0x2eb6(%rip),%rax        # 3fe0 <_ITM_deregisterTMCloneTable>
...
00000000000011c9 <main>:
    ...
    11e4:	48 b8 77 61 6e 67 65 	movabs $0x7265676e6177,%rax
    11eb:	72 00 00 
    ...
    120f:	e8 bc fe ff ff       	callq  10d0 <gets@plt>
    1214:	48 8d 55 e8          	lea    -0x18(%rbp),%rdx
    1218:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
    121c:	48 89 d6             	mov    %rdx,%rsi
    121f:	48 89 c7             	mov    %rax,%rdi
    1222:	e8 99 fe ff ff       	callq  10c0 <strcmp@plt>
    1227:	85 c0                	test   %eax,%eax
    1229:	74 0e                	je     1239 <main+0x70>
    122b:	48 8d 3d e7 0d 00 00 	lea    0xde7(%rip),%rdi        # 2019 <_IO_stdin_used+0x19>
    1232:	e8 59 fe ff ff       	callq  1090 <puts@plt>
    1237:	eb b9                	jmp    11f2 <main+0x29>
    1239:	90                   	nop
    123a:	48 8d 3d f6 0d 00 00 	lea    0xdf6(%rip),%rdi        # 2037 <_IO_stdin_used+0x37>
    1241:	b8 00 00 00 00       	mov    $0x0,%eax
    1246:	e8 65 fe ff ff       	callq  10b0 <printf@plt>
    124b:	b8 00 00 00 00       	mov    $0x0,%eax
    1250:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1254:	64 48 33 0c 25 28 00 	xor    %fs:0x28,%rcx
    125b:	00 00 
    125d:	74 05                	je     1264 <main+0x9b>
    125f:	e8 3c fe ff ff       	callq  10a0 <__stack_chk_fail@plt>
    1264:	c9                   	leaveq 
    1265:	c3                   	retq   
